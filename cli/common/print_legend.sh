...
echo -e "                     ${bold}${COLOR_ON1}CPUs ${COLOR_ON2}Adaptive Devices ${COLOR_ON5}GPUs${COLOR_OFF}${normal}"
elif [ "$is_acap" = "1" ] || [ "$is_fpga" = "1" ]; then
echo -e "                     ${bold}${COLOR_ON1}CPUs ${COLOR_ON2}Adaptive Devices${COLOR_OFF}${normal}"
elif [ "$is_gpu" = "1" ]; then
echo -e "                     ${bold}${COLOR_ON1}CPUs ${COLOR_ON5}GPUs${COLOR_OFF}${normal}"
fi