...
#usage:       $CLI_PATH/sgutil build aved --tag                          $github_tag --project $project_name --version $vivado_version --all $all 
#example: /opt/sgrt/cli/sgutil build aved --tag amd_v80_gen5x8_23.2_exdes_2_20240408 --project   hello_world --version          2022.2 --all    1 
