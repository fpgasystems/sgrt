...
#usage:       $CLI_PATH/sgutil program aved --device $device_index --project $project_name --tag                            $tag_name --remote $deploy_option 
#example: /opt/sgrt/cli/sgutil program aved --device             1 --project   hello_world --tag amd_v80_gen5x8_23.2_exdes_2_20240408 --remote              0 
...
#program bitstream 
$CLI_PATH/program/vivado --bitstream $DIR/$BITSTREAM_NAME --device $device_index --version $vivado_version --remote 0
